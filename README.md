...
- Architected a configuration-driven approach to plan/pricing structures, moving away from hardcoded logic to improve flexibility and reduce technical debt
...
Key projects led include:
- Orchestrated seamless migration of payment processing from Braintree to Stripe for all net new revenue with zero customer impact
- Re-engineered usage-based data infrastructure from AWS Redshift to Clickhouse, achieving zero downtime while significantly improving query performance
- Executed zero-data-loss migration of mission-critical background jobs from legacy Redis infrastructure
...
[github](https://github.com/bryanmikaelian), [linkedin](https://linkedin.com/in/bryanmikaelian)
